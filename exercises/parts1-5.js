...
//console.log(`It will take ${SpacecraftName} ${getDaysToLocation(kilometersToTheMoon)} to get to the Moon.`)
...
// console.log(`It will take ${spaceShuttle.name} ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} to get to the Moon.`)
